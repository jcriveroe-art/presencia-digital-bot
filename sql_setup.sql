...
ADD COLUMN IF NOT EXISTS fuente_busqueda TEXT,
ADD COLUMN IF NOT EXISTS estado_contacto TEXT,
ADD COLUMN IF NOT EXISTS siguiente_accion TEXT,
ADD COLUMN IF NOT EXISTS fecha_siguiente_seguimiento TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS ultimo_contacto TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS ultima_respuesta TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS intentos_contacto INTEGER,
ADD COLUMN IF NOT EXISTS producto_interesado TEXT,
ADD COLUMN IF NOT EXISTS monto_cotizado NUMERIC,
...
ADD COLUMN IF NOT EXISTS ultima_alerta_json_bloqueado_at TIMESTAMP WITH TIME ZONE;
