...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width: 768px) {
      html, body { width: 100%; max-width: 100%; height: 100% !important; margin: 0; padding: 0 !important; overflow: hidden; display: flex !important; flex-direction: column !important; }
      body { padding-top: 0 !important; }
      header { position: relative !important; top: auto !important; left: auto !important; right: auto !important; height: 52px; flex-shrink: 0 !important; grid-template-columns: auto minmax(0, 1fr) auto; padding: 0 8px; gap: 6px; }
      ...
      .page { flex-grow: 1 !important; height: 0 !important; overflow: hidden; }
      ...
      .page.view-leads.mobile-chat-open form { grid-row: 3; position: sticky; bottom: 0; grid-template-columns: minmax(0, 1fr) 44px; padding: 7px 8px calc(7px + env(safe-area-inset-bottom, 8px)) !important; background: #f0f2f5 !important; border-top: 1px solid var(--line); align-items: center; }
